...
<nav>
    ...
    <div class="nav"><input type="text" name="recherche" placeholder="Recherche">
        <button type="submit"><img src="loupe.png" alt="Loupe"></button>
    </div>
    <div class="nav"><p><?= $_SESSION['prenom'] . " " . strtoupper($_SESSION['nom']) ?></p><br><a
            href="deconnexion.php">Se déconnecter</a></div>
</nav>