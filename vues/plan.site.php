    <div class="main">
      ...
      <a href="index.php?cible=test&fonction=test" class="link">Tests</a><br>
      <a href="index.php?cible=utilisateurs&fonction=faq" class="link">Foire Aux Questions</a><br>
      <a href="index.php?cible=utilisateurs&fonction=contact" class="link">Contact</a><br>
      <a href="index.php?cible=utilisateurs&fonction=mentions_legales" class="link">Mentions Légales</a><br>
      <a href="index.php?cible=utilisateurs&fonction=cgu" class="link">Conditions Générales d'Utilisation</a><br>
    </div>
